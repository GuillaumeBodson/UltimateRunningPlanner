...
public interface IPaceCalculatorClient
{
    ...
    Task<MultiplePerformancesPredictionDto> EstimateMultipleAsync(IReadOnlyList<int> distancesMeters, IReadOnlyList<PerformanceDto> performances, CancellationToken ct = default);
